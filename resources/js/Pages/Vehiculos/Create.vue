    ...
    <AuthenticatedLayout>
        <div class="max-w-7xl mx-auto py-6">
            <div class="flex items-center justify-between mb-8">
                <div>
                    <h1 class="text-3xl font-black text-gray-900 tracking-tight">REGISTRAR NUEVO VEHÍCULO</h1>
                    <p class="text-gray-500 mt-1">Complete todos los campos para dar de alta un nuevo automotor en el sistema.</p>
                </div>
                        ...
                        <section>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                                ...
                                <div>
                                    ...
                                    <TextInput id="numero_circulacion" v-model="form.numero_circulacion" class="mt-1 block w-full uppercase" placeholder="Ej: 12345678" required />
...
<style scoped>
.form-input-custom {
    @apply border-gray-200 focus:border-indigo-600 focus:ring-indigo-600 rounded-xl transition-all;
}
</style>
